 ...
 */
 ...
 export default class WaveForm extends PureComponent<WaveObjectPropsType, StateType> {
   constructor(props) {
     ...
     this._onFinishInit = this._onFinishInit.bind(this);
   }
   ...
   render() {
     ...
     return (
       <OGWaverformView 
         ...
         onFinishInit={this._onFinishInit}/>
     );
   }
 }
